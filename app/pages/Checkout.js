...
export default function Checkout({navigation}) {
  ...
  const obterItens = () => {
    helper.obterItens().then(produtos => {
    ...
    <ScrollView style={{backgroundColor: '#fff'}}>
      ...
      <Card>
        ...
        <Card.Content>
          ...
          <View>
            <Text style={{fontSize: 14}}>Quantidade de itens: {qtdItens}</Text>
          </View>
        </Card.Content>
      </Card>
          ...
          return (
            <Card key={i}>
              <Card.Content>
                ...
                <View>
                  <Text>
                    Preço: R$ {item.preco}, Qtd: {item.quantidade}, Total:{' '}
        ...
        <Card.Content>
          ...
          {endereco != null && (
            <View style={{marginTop: 10, fontSize: 15}}>
              ...
              <Text>
                Bairro: {endereco.bairro}, Cidade: {endereco.localidade}, UF:{' '}
                {endereco.uf}
              </Text>
